...
namespace testando
{
    public partial class Frmreservas : Form
    {
        ...
        private void btnreservar_Click(object sender, EventArgs e)
        {
            ...
            reservasModelo.datainr = Convert.ToDateTime(dTentrada.Value);// ToString("yyyy-MM-dd hh:mm:ss"));
            reservasModelo.dataoutr = Convert.ToDateTime(dTsaida.Value);// ToString("yyyy-MM-dd hh:mm:ss");
